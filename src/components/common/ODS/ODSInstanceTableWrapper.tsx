      ...
      <Flex mt='16px' w='full'>
        <ODSInstanceManagementTable 
          ...
          tableHeaders={[
            ...
            <ControlTableHeader headerData={{ text: 'Ed-Fi Data Models', fieldName: 'EdFiDataModels', sortedByField: orderBy.field, showSorting: true, sortingType: orderBy.order, onSortAsc: () => onOrderBy('EdFiDataModels', 'asc'), onSortDesc: () => onOrderBy('EdFiDataModels', 'desc') }} />,
