...
const ApplicationAPIFormClientTabContent = ({ clientData, mode, isRegeneratingCredentials, onRegenerateCredentials }: ApplicationAPIFormClientTabContentProps) => {
    ...
    return (
        <Flex flexDir='column' mt='0px' w='full'>
            {clientData.key !== 'applicationKey' && <Alert fontFamily='Open sans' fontSize='12px' status="info" mt='10px' padding='10px'>
                <AlertIcon />
            ...
            { mode === 'edit' && <Flex flexDir='column'>
                    ...
                    <Alert fontFamily='Open sans' fontSize='12px' status='warning' mt='10px' padding='10px'>
                        <AlertIcon />
