...
import {
  AddUserRequest, AssignBulkLicensesRequest, AssignLicenseRequest, InviteUserRequest, RevokeBulkLicensesRequest, RevokeLicenseRequest, UpdateUserRequest 
} from '../../../services/AdminActions/Users/UsersService.requests'
import useEDXToast from '../../common/useEDXToast'
import {
  CreateUserFormData, SubscriptionOption 
...
const useUserFormActions = () => {
  ...
  const selectBulkRequests = (editUserInitialData: AppUser, subscriptionsOptionList: SubscriptionOption[]) => {
    ...
    for (const option of subscriptionsOptionList) {
